  ...
  return (
    <Section id="progress" className="bg-cream-50">
      <SectionHeading
        ...
        title="You're not opening an app. You're continuing a journey."
        className="max-w-2xl"
      >
        Every session builds on the last. Every rep compounds. Open KLAM and see
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Tile label="Current streak">
          ...
          <p className="mt-3 inline-flex items-center gap-1.5 rounded-full bg-terracotta-500/15 px-3 py-1 text-caption font-medium text-ink-800">
            <span aria-hidden="true">🔥</span> 84-day streak
          </p>
        </Tile>
        ...
        <Tile label="Level 18 · Communication Expert">
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-caption text-ink-500">240 XP to level 19</p>
          </div>
        </Tile>
